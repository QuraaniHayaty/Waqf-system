...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        /* قائمة الروابط بنفس ستايل ولون الخط */
        ...
        /* الشريط العلوي: نفس لون خط ستايل قرآني حياتي الأخضر المميز وبحجم ووزن خط متطابق */
        .top-header-bar { background-color: #fcf6f5; padding: 15px 30px; border-bottom: 1px solid #f2e8e6; text-align: right; font-size: 22px; font-weight: 700; color: #2e5a36; letter-spacing: 0.5px; }
...
<body>
    ...
    <main>
        ...
        <div class="content-area">
            <p>تم ضبط لون الخط الأخضر المميز وستايل الخطوط في الشريط العلوي والقائمة الجانبية لتطابق نظام قرآني حياتي تماماً. أخبرني هل النقطة هذه أصبحت مطابقة 100% لنبدأ ببرمجة الأقسام؟</p>
        </div>
    </main>
</body>
</html>
